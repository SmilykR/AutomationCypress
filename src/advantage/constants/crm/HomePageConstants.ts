export default class HomePageConstants {
    ...
    static readonly MYWORK_FIRMS = "Firms";
    ...
    static readonly NAV_BAR = "Navigation my work Tab";
    static readonly MYWORK_FIRMS_NEW_BTN="Firms New Button";
    static readonly FIRMS_SAVE_CLOSE="Firms Sve and Close Button";
